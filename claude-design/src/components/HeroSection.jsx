    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    backgroundImage: `linear-gradient(rgba(253, 248, 240, 0.78), rgba(253, 248, 240, 0.88)), url('/images/hero-bg.jpg')`
                }}
            />
                ...
                <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 text-center">
                    ...
                    >
                        <div className="mb-8 sm:mb-10 flex flex-col items-center">
                            ...
                            <h1
                                className="text-3xl sm:text-5xl font-light text-[#4C4A49] tracking-wide mb-3"
                                itemProp="name"
                            >
                                אביהו סיטון
                            </h1>
                            ...
                            <h2 className="text-lg sm:text-2xl text-[#4C4A49] font-light mb-3 leading-relaxed px-2 max-w-2xl mx-auto">
                    ...
                    >
                        <button
                            ...
                            className="w-full sm:w-auto bg-[#A2673E] hover:bg-[#8d5a36] text-white px-8 py-3.5 rounded-lg text-base sm:text-lg transition-all duration-300 shadow-lg font-light flex items-center justify-center gap-3"
                        >
                        ...
                        <button
                            ...
                            className="w-full sm:w-auto border border-[#A2673E]/60 bg-white/80 backdrop-blur-sm text-[#A2673E] hover:bg-[#A2673E] hover:text-white px-8 py-3.5 rounded-lg text-base sm:text-lg transition-all duration-300 font-light flex items-center justify-center gap-3"
                        >
