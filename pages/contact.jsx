                    ...
                    >
                        ...
                        <div className="grid lg:grid-cols-1 gap-12 max-w-4xl mx-auto">
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                                <a
                                    href="https://wa.me/972532853235?text=%D7%A9%D7%9C%D7%95%D7%9D%20%D7%90%D7%91%D7%99%D7%94%D7%95%20-%20%D7%90%D7%A9%D7%9E%D7%97%20%D7%9C%D7%A9%D7%95%D7%97%D7%97"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="bg-white p-6 rounded-xl border border-[#D3C1B1] hover:shadow-md transition-all text-center group"
                                    onClick={() => {
                                ...
                                <a
                                    href="tel:0532853235"
                                    className="bg-white p-6 rounded-xl border border-[#D3C1B1] hover:shadow-md transition-all text-center"
                                    onClick={() => {
                                        if (typeof gtag === 'function') {
