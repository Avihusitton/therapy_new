    ...
    const faqs = [
        {
            ...
            a: "הטיפול מתאים לגברים שחווים תקיעות, שחיקה שקטה, קשיים בזוגיות, חזרה מהמילואים, או רצון לעשות איפוס אמצע החיים. אם אתה מרגיש שמשהו לא עובד — גם בלי שיש 'משבר' ברור — זה בדיוק הזמן לשבת ולעשות קריאת כיוון."
        },
        {
                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl text-[#4C4A49] mb-8 font-light text-center">
                            המרחב האישי <span className="whitespace-nowrap">— לעשות סדר ולזוז</span>
                        </h1>
                        <p className="text-lg text-[#7A7068] text-center mb-4 font-light">
                          עבודה פנימית בשיטת דרך | קליניקה ברמת נגב ומפגשים בזום
                        </p>
                        ...
                        <div className="text-lg text-[#4C4A49] leading-relaxed space-y-8 mb-16 font-light">
                            <p className="text-xl font-normal border-r-4 border-[#A2673E] pr-6 py-2 bg-[#FDF8F0]/50 rounded-lg">
                                לפעמים זה מרגיש שהחיים פשוט קורים. אתה מגיב לאירועים, מתמודד עם לחצים, ומוצא את עצמך בלופ של תגובות אוטומטיות שמשאירות אותך עייף ותקוע.
                            </p>
                            <p>
                                אם אתה מרגיש שהקול הפנימי שלך קצת הלך לאיבוד בתוך הרעש של היום-יום, או שיש דפוסים שחוזרים על עצמם ושואבים מכם אנרגיה — אתה לא לבד. העבודה בשיטת &quot;דרך&quot; היא לא רק &quot;לדבר על הבעיות&quot;. זו עבודה כנה ומעשיתית שעוזרת לך להבין איפה אתה מאבד את הבחירה החופשית.
                            </p>
                            <p>
                                המטרה שלי היא לא שתהיה תלוי במטפל. אתה יוצא מכאן עם ארגז כלים שעובדים בשבילך — שידע לפרק את הפלונטר, להכיר את הלופים שחוזרים, ולהחזיר את ההגה לידיים שלך.
                            </p>
                        </div>
                        ...
                        <div className="py-20">
                            ...
                            <div className="grid md:grid-cols-3 gap-8">
                                <div className="text-center">
                                    ...
                                    <h3 className="text-xl text-[#4C4A49] mb-4">קריאת כיוון — צעד ראשון</h3>
                                    <p className="text-[#6B6867] font-light leading-relaxed">
                                        יושבים יחד, כוס קפה, אתה מספר מה מביא אותך ואני מספר איך אני עובד. ללא התחייבות.
                                    </p>
                                </div>
                                <div className="text-center">
